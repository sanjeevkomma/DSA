...
public class MergeSort_Recursion { // Function to merge the sub arrays of arr[]  
	...
	static void mergeSort( int arr[], int beginIndex, int endIndex ) {
		if ( beginIndex < endIndex )   {
			...
			merge(arr, beginIndex, midIndex, endIndex);
		}  
	}

	static void  merge( int arr[], int beginIndex, int midIndex, int endIndex )   {
		int i, j, k;
		int leftArrayLength = midIndex - beginIndex + 1;
