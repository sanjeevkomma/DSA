...
public class LinkedList_Find_MiddleElement {
	...
	public static void main(String args[]) {
		...
		linkedList.add( new LinkedList.Node("23"));
		linkedList.add( new LinkedList.Node("94"));
		linkedList.add( new LinkedList.Node("77"));
